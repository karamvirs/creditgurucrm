<div style="float: left; margin: 0px 0px 10px 0px; padding: 0px; width:100%; border-top: 2px solid #4E8CCF;">
    ...
    <div style="float: left;  padding: 2px">
    ...
    </div><div style="float: left;  padding: 2px">
        <form target="_blank" method="POST" action="/sugarcrm/index.php?module=abc_Creditors&action=index">
            ...
            <input type="button" value="Show creditors" onclick="this.form.submit()" />
        </form>
    </div>
   <!--         
    <div style="float: left;  padding: 2px"><form action="">
            <input type="hidden" value="{$bean->id}" name="abc_creditors_contacts_id_basic" id="c_id"/>
            <input type="button" value="Send Password Email" name="emailsend" id="sendemail"/>
        </form>
    </div>-->
    <div style="float: left;  padding: 2px"><form action=''>
                    ...
                    <tr>
                        ...
                        {else}
                            ...
                            <script type="text/javascript">SUGAR.util.doWhen("typeof initPanel == 'function'", function () {ldelim}
                                    initPanel({{$smarty.foreach.section.iteration}}, '{{$panelState}}');
                                {rdelim});</script>
                                {{/if}}
                                {{/if}}
                        </div>
