...
class SugarWidgetSubPanelEchoSignQuickCreateDocument extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	{
		$this->form_value = translate('LBL_UPLOAD_DOCUMENT', 'echo_Agreements');
