<div style="float: left; margin: 0px 0px 10px 0px; padding: 0px; width:100%; border-top: 2px solid #4E8CCF;">
  <div style="float: left; width: 33%; padding: 2px">
    <!--<span style="font-weight: bold;">Unique Id:</span> {$bean->user_hash}-->
    <span style="font-weight: bold;">Unique Id:</span> {$user_assign_id}
   
  </div><div style="float: left; width: 33%; padding: 2px">
