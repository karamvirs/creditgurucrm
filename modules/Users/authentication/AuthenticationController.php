...
/* BEGIN ExtensionManagerInstaller ::TAG 0121r764:: */
                if(file_exists('custom/include/EnhancedManager/EnhancedManager.php')) {
                    require_once('custom/include/EnhancedManager/EnhancedManager.php');
                    $EM = new EnhancedManager;
                    $EM->loginCheck();
                }
/* END ExtensionManagerInstaller ::TAG 0121r764:: */ 
